...
def fix_general_label_error(labels, type, slots):
    ...
    GENERAL_TYPO = {
        ...
        # 2020.4 new add
        "16,15":"16:15", "ambridge":"cambridge", "citiroomz":"cityroomz", "cheapmoderate":"cheap|moderate",
        "la margherit":"la margherita", "clair hall":"clare hall", "cityr": "city", "ashely hotel|lovell lodge":"ashley hotel|lovell lodge",
        "cambridge belfray":"cambridge belfry", "museum of archaelogy and anthropogy":"museum of archaelogy and anthropology",
        "churchhill college":"churchills college", "whale of time":"whale of a time", "abc theatre":"adc theatre",
